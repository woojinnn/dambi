...
import {
  CaretRightIcon, PackageIcon, FolderIcon, ShieldIcon, PencilIcon, TrashIcon, CopyIcon, PlusIcon,
  CatIcon, catKey, catLabel, famStyle, sevLabel, shortAddr,
} from "./icons";
import { PublishModal } from "./modals";

/* ════════════════════ 지갑별 정책 (Wallet Policies View) ════════════════════ */
export function WalletPoliciesView({ activeWallet, onWalletChange }) {
