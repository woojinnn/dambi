...
import { run, NewPolicyChooser, LibraryDirectory, DefDefaultsModal, defUsageCount } from "./list";
import { SearchIcon, PlusIcon, catKey, catLabel, catStyle, CAT_ORDER } from "./icons";
import { PublishModal } from "./modals";
import { Editor2View } from "./editor2";
...
export function LibraryTab({ snap }) {
