/* ════════════════════ Address picker · Custom-field modal · Manifest preview ════════════════════
 * These mirror the extension's editor-v9 surfaces that the form pane relies on:
 *  - AddressInput / AddressSetInput — name-resolving 0x inputs (address book)
 *  - CustomFieldModal — "+ 새 보강 필드 만들기" (policy-server method → context.custom.*)
 *  - ManifestPreview — collapsible auto-generated manifest, with hand-edit override
 * ──────────────────────────────────────────────────────────────────────────── */
...
/* ── multi-address (allowlist) input: resolved chips + autocomplete add box ── */
...
/* ════════════════════ ManifestPreview — 자동 생성 manifest 미리보기/직접 편집 ════════════════════ */
