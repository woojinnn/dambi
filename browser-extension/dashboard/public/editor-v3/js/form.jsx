...
/* known enum value suggestions (datalist hints — not enforced) */
...
/* 주소 표시 — 저장된 주소(지갑·토큰)는 이름으로, 미저장 주소는 짧은 해시로. 주소가 아니면 null. */
...
/* ── FieldCombobox: native select grouped by role (wrapped in .fc) ── */
