...
/**
 * Stable union of protocol source kinds. **Must stay in sync with the
 * `ProtocolSourceKind` declared in `build-index.ts`** — that declaration is
 * authoritative for the validator surface; this one is what resolver files
 * pattern-match on.
 */
