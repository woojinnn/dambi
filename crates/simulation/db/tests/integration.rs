...
// `execution_reports_round_trip_and_reconcile_by_wallet` was removed
// alongside the `execution_reports` repository (migration 010 drops the
// underlying table — the data moved to `chrome.storage.local`).
