//! PancakeSwap V2 Router `swapExactTokensForETH(uint256 amountIn,
//! uint256 amountOutMin, address[] path, address to, uint256 deadline)`.
//! Output is native BNB on BSC.
...
pub struct Params {
    ...
    pub amount_in: U256,
    /// Minimum acceptable BNB output amount.
...
impl Adapter for Adapter_ {
    fn id(&self) -> AdapterId {
        static_adapter_id("pancakeswap-amm/swapExactTokensForETH@0.1.0")
    }
    ...
    fn build(&self, tx: &TransactionRequest) -> Result<Action, AdapterError> {
        ...
        Ok(dex_swap_action(
            ...
            &recipient_addr,
            Some(25),
            "pancakeswap-amm/swapExactTokensForETH",
        ))
    }
}
...
mod tests {
    ...
    fn sample_params() -> Params {
        Params {
            amount_in: U256::from(200_000_000_000_000_000_000_u128),
    ...
    #[test]
    fn build_marks_native_bnb_as_output_token() {
