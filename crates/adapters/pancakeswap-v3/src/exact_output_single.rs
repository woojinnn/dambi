//! PancakeSwap V3 SwapRouter `exactOutputSingle`. Layout identical to Uniswap V3.
...
/// Adapter for PancakeSwap V3 `exactOutputSingle`.
#[derive(Debug)]
pub struct Adapter_ {
...
impl Adapter for Adapter_ {
    fn id(&self) -> AdapterId {
        static_adapter_id("pancakeswap-v3/exactOutputSingle@0.1.0")
    }
...
mod tests {
    ...
    #[test]
    fn build_uses_amount_in_maximum_for_oracle_input() {
