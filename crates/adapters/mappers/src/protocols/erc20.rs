...
mod tests {
    ...
    fn build_decoded(spender: Address, amount: alloy_primitives::U256) -> DecodedCall {
        DecodedCall {
            decoder_id: DecoderId::new(ERC20_APPROVE_DECODER_ID),
    ...
    fn unlimited_approve_maps_to_unlimited_kind() {
        ...
        let decoded = build_decoded(spender.clone(), alloy_primitives::U256::MAX);
    ...
    fn exact_approve_maps_to_exact_amount() {
        ...
        let decoded = build_decoded(spender, alloy_primitives::U256::from(123_456_789_u64));
